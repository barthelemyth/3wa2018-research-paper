...
var nbrephrase=phrases.length;
var boucle;
document.write(nbrephrase);

var nbrecar=phrases[1].length;
document.write(nbrecar);

 
for(boucle=0;boucle<nbrephrase;boucle++)
{
    document.write("<p>"+phrases[boucle].length+"</p>");
}

var min=phrases[0].length;
...
{ 
    ...
    if(min<phrases[boucle].length)
    {
        min = phrases[boucle].length;
    }
}
...
{var i= boucle+1
    ...
    if(phrases[boucle].length<phrases[i].length)
    {
        index=boucle;
    }
}
